    ...
    <>
      <nav className="bg-[#83C5BE] py-6 px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          <IoMdNotificationsOutline size={23} className="cursor-pointer" />
          <MdOutlineDarkMode size={23} className="cursor-pointer" />
          <FaRegUserCircle size={23} className="cursor-pointer" />
        </div>
      </nav>
      <div className="flex  h-[100%]">
        ...
        <div className="basis-[80%] no-scrollbar ">
                  {props.children}
        </div>
      </div>
    </>
